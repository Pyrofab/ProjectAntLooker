...
adaptive fr.antproject.utils.threshold algorithm see cv\+::adaptive\+Threshold enum cv\+::\+Adaptive\+Threshold\+Types the fr.antproject.utils.threshold value $T(x,y)$ is a mean of the $\texttt{blockSize} \times \texttt{blockSize}$ neighborhood of $(x, y)$ minus C \mbox{\Hypertarget{group__imgproc__misc_ga42b2263bdd1223c126d6102a1afc9cf4}\label{group__imgproc__misc_ga42b2263bdd1223c126d6102a1afc9cf4}}
...
type of the fr.antproject.utils.threshold operation  enum cv\+::\+Threshold\+Types \[\texttt{dst} (x,y) = \fork{\texttt{maxval}}{if \(\texttt{src}(x,y) > \texttt{thresh}\)}{0}{otherwise}\]