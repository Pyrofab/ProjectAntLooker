...
enum class ThresholdTypes(val value: Int) {
    /** value = value > fr.antproject.antlookercore.threshold ? max_value : 0       */
    BINARY(0/*Imgproc.CV_THRESH_BINARY*/),
    /** value = value > fr.antproject.antlookercore.threshold ? 0 : max_value       */
    BINARY_INVERTED(1/*Imgproc.CV_THRESH_BINARY_INV*/),
    /** value = value > fr.antproject.antlookercore.threshold ? fr.antproject.antlookercore.threshold : value   */
    TRUNCATED(2/*Imgproc.CV_THRESH_TRUNC*/),
    /** value = value > fr.antproject.antlookercore.threshold ? value : 0           */
    TO_ZERO(3/*Imgproc.CV_THRESH_TOZERO*/),
    /** value = value > fr.antproject.antlookercore.threshold ? 0 : value           */
