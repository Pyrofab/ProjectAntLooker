...
import fr.antproject.antlookercore.model.diagram.PetriNet;
import fr.antproject.antlookercore.model.diagram.components.*;
...
public class PetriTransformer implements IDiagramTransformer<PetriNet> {
    ...
    public PetriNet transformDiagram(DiagramBase base) {
        ...
        return new PetriNet(nodes.values(), "n1");
    }
